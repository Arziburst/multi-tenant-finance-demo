export const proposeRecategorizeTool = {
  type: "function" as const,
  function: {
    name: "propose_recategorize",
    description:
      "Propose recategorizing a set of existing transactions to a given category. " +
      "Must reference real transaction IDs previously provided by the system.",
    strict: true,
    parameters: {
      type: "object",
